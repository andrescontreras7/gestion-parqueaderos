...
export default function NotFound() {
  return (
    ...
    <main className="h-screen w-full flex flex-col justify-center items-center bg-[#ff004a]">
        <h1 className="text-9xl font-extrabold text-white tracking-widest mb-2">Error</h1>
        <p className='text-md font-extrabold text-white tracking-widest' >
          Espacios no encontrados
        </p>
